const Contact = (props) => {
    return (
        <div className="row p-2 mb-2" style={{ borderRadius: "20px", border: "1px solid #555" }}>
            ...
            <div className="col-2 col-md-2 pt-md-3">
                <button className={`btn btn-sm m-1 ${props.contact.isFavorite ? "btn-warning" : "btn-outline-warning"}`}
            ...
            <div className="col-2 col-md-3 pt-md-3">
                <button className="btn btn-primary btn-sm m-1" onClick={() => props.editContact(props.contact)}>
