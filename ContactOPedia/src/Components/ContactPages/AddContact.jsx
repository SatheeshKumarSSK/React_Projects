...
class AddContact extends React.Component {
    ...
    handleAddContactFormSubmit = (e) => {
        ...
        if (this.props.isUpdating) {
            ...
            response = this.props.AddContact({ name: name, email: mail, phone: phoneNo });
        }
            ...
            <div className="border col-12 p-2">
                <form onSubmit={this.handleAddContactFormSubmit} className="contact-form">
                    ...
                    <div className="row p-2">
                        ...
                        <div className={`col-12 p-1 ${this.props.isUpdating ? "col-md-4 offset-md-2" : "col-md-4 offset-md-4"}`}>
